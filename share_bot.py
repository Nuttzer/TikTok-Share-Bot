...
print( Fore.RED + "recomended 100 shared per second ")
...
class tiktok:
    ...
    def update_title(self):
        ctypes.windll.kernel32.SetConsoleTitleW(
            f"TikTok Share Botter | Sent Shares: {self.shared} | Errors: {self.errors} | https://github.com/Nuttzer/TikTok-Share-Bot")
    ...
    def main(self):
        os.system(clear)
        if clear == "cls":
            ctypes.windll.kernel32.SetConsoleTitleW(f"TikTok Share Bot | https://github.com/Nuttzer/TikTok-Share-Bot ")
        ...
        print(Fore.LIGHTGREEN_EX + "it will show that there is alot of errors but just let it run | feel free to run a few  at a time  ")
